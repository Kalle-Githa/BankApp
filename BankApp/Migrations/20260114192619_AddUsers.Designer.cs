...
namespace BankApp.Migrations
{
    ...
    [Migration("20260114192619_AddUsers")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("BankApp.Data.Entities.AccountType", b =>
                {
            ...
            modelBuilder.Entity("BankApp.Data.Entities.Card", b =>
                {
            ...
            modelBuilder.Entity("BankApp.Data.Entities.Customer", b =>
                {
            ...
            modelBuilder.Entity("BankApp.Data.Entities.Disposition", b =>
                {
                    b.Property<int>("DispositionId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("BankApp.Data.Entities.Loan", b =>
                {
            ...
            modelBuilder.Entity("BankApp.Data.Entities.User", b =>
                {
            ...
            modelBuilder.Entity("BankApp.Data.Entities.Account", b =>
                {
                    b.HasOne("BankApp.Data.Entities.AccountType", "AccountTypes")
                        .WithMany("Accounts")
            ...
            modelBuilder.Entity("BankApp.Data.Entities.Card", b =>
                {
                    b.HasOne("BankApp.Data.Entities.Disposition", "Disposition")
                        .WithMany("Cards")
            ...
            modelBuilder.Entity("BankApp.Data.Entities.Disposition", b =>
                {
                    ...
                    b.HasOne("BankApp.Data.Entities.Customer", "Customer")
                        .WithMany("Dispositions")
            ...
            modelBuilder.Entity("BankApp.Data.Entities.Transaction", b =>
                {
                    b.HasOne("BankApp.Data.Entities.Account", "AccountNavigation")
